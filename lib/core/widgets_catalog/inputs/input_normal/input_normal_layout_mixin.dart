...
mixin InputNormalLayoutMixin {
  ...
  Widget buildLabelAndHint() {
    return (customLabel != null || labelText != null || customHint != null || hintText != null)
        ? Row(
  ...
  OutlineInputBorder buildBorder() {
    ...
    double opacity = !(enable == true) ? 0.5 : (focusNode?.hasFocus == true ? 0.5 : 1);
  ...
  bool buildFilled() {
    if (feedBackType == FeedbackType.none && (!(enable == true) || (viewOnly == true))) {
      return true;
    }
    return false;
  }
